...
CANON = {
    # ── colors → the evaluator's 12-word COLOR_RE vocabulary ──────────────
    "violet":"purple","lilac":"purple","lavender":"purple","mauve":"purple",
    "plum":"purple","orchid":"purple","amethyst":"purple","grape":"purple",
    "eggplant":"purple","aubergine":"purple","mulberry":"purple","iris":"purple",
    "crimson":"red","scarlet":"red","maroon":"red","burgundy":"red","cherry":"red",
    "ruby":"red","wine":"red","brick":"red","garnet":"red","cardinal":"red",
    "carmine":"red","vermilion":"red","cranberry":"red",
    "navy":"blue","azure":"blue","cobalt":"blue","indigo":"blue","turquoise":"blue",
    "sapphire":"blue","cerulean":"blue","aqua":"blue","aquamarine":"blue",
    "periwinkle":"blue","cornflower":"blue",
    "charcoal":"gray","slate":"gray","ash":"gray","graphite":"gray","pewter":"gray",
    "silver":"gray","smoke":"gray","gunmetal":"gray","granite":"gray","heather":"gray",
    "ivory":"white","cream":"white","eggshell":"white","pearl":"white","snow":"white",
    "alabaster":"white","bone":"white",
    "ebony":"black","jet":"black","onyx":"black","obsidian":"black","raven":"black",
    "coal":"black",
    "tan":"brown","beige":"brown","khaki":"brown","taupe":"brown","chocolate":"brown",
    "coffee":"brown","mocha":"brown","camel":"brown","caramel":"brown","bronze":"brown",
    "walnut":"brown","chestnut":"brown","cognac":"brown","sand":"brown",
    "espresso":"brown","fawn":"brown","sienna":"brown","mahogany":"brown",
    "olive":"green","emerald":"green","sage":"green","mint":"green","lime":"green",
    "jade":"green","moss":"green","fern":"green","kelly":"green","seafoam":"green",
    "pistachio":"green","forest":"green",
    "fuchsia":"pink","rose":"pink","blush":"pink","salmon":"pink","magenta":"pink",
    "coral":"pink","bubblegum":"pink","flamingo":"pink","peony":"pink",
    "golden":"yellow","mustard":"yellow","lemon":"yellow","canary":"yellow",
    "daffodil":"yellow","sunflower":"yellow","banana":"yellow","maize":"yellow",
    "amber":"orange","rust":"orange","tangerine":"orange","peach":"orange",
    "apricot":"orange","pumpkin":"orange","papaya":"orange","persimmon":"orange",
    # ── materials → the evaluator's 9-word MATERIAL_RE vocabulary ─────────
    "poly":"polyester","polyblend":"polyester","microfiber":"polyester",
    "fleece":"polyester","plush":"polyester","furry":"polyester",
    "denim":"cotton","chino":"cotton","twill":"cotton","jersey":"cotton",
    "flannel":"cotton","terry":"cotton","canvas":"cotton","muslin":"cotton",
    "corduroy":"cotton","calico":"cotton","poplin":"cotton","gingham":"cotton",
    "pleather":"leather","suede":"leather","hide":"leather","cowhide":"leather",
    "nubuck":"leather","buckskin":"leather","calfskin":"leather","lambskin":"leather",
    "merino":"wool","woolen":"wool","cashmere":"wool","mohair":"wool","alpaca":"wool",
    "angora":"wool","tweed":"wool","lambswool":"wool","worsted":"wool","shearling":"wool",
    "lycra":"spandex","elastane":"spandex",
    "satin":"silk","silken":"silk","charmeuse":"silk",
    "viscose":"rayon","modal":"rayon","tencel":"rayon","lyocell":"rayon",
    "polyamide":"nylon",
}
def _canon_text(t):
    out=[]
